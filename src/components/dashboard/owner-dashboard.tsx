...
export function OwnerDashboard() {
  ...
  const dashboardTitle = role === 'owner' ? "Salon Owner Dashboard" : "Salon Staff Dashboard";
  return (
    <div className="container mx-auto py-12 px-4">
      <header className="mb-10">
        <h1 className="text-4xl font-bold tracking-tight text-primary">{dashboardTitle}</h1>
        <p className="mt-2 text-lg text-muted-foreground">
          Welcome, {user?.firstName}! Manage your salon, view reports, and grow your business.
        </p>
      </header>
      ...
      <div className="mt-12 flex flex-col items-center gap-4">
        ...
        <Button variant="ghost" onClick={logout} className="text-muted-foreground hover:text-primary">
